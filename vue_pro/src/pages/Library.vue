    ...
    <div class="music-library unselectable " @contextmenu.prevent="startSelectMode(true)">
        ...
        <div v-if="selectMode" class="context-menu-background">
            <div class="context-menu-options">
                ...
                <div class="context-menu-option" @dblclick="deleteFromLibrary">从库删除</div>
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            this.$store.commit('SET_FILTER_TYPE','')
        },
        data(){
            return{
        ...
        methods :{
            ...
            ...mapMutations(['DELETE_FROM_PLAYLIST','SET_SELECT_MODE','ADD_TO_PLAYLIST','DELETE_FROM_LIBRARY']),
            showAddToPlaylist(){
            ...
            deleteFromLibrary(){
                ...
                this.DELETE_FROM_LIBRARY(this.selectedSongsIndex)
                console.log(toDeleteSongsId)
                this.showPlaylistModal = false;
                this.exitSelectMode(false)
                myAPI.deleteFromLibrary(toDeleteSongsId)
            },
            exitSelectMode(flag){
                //console.log(new Date(this.$store.state.songs.songs[this.selectedSongsIndex[0]].cTime).getTime())
                this.SET_SELECT_MODE(flag)
                this.selectedSongsIndex = [];
                this.songsWithSelection.forEach((song) =>{
                    song.isSelected = false
